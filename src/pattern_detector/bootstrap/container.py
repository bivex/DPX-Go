"""Dependency Injection container wiring hexagonal ports and adapters for DPX-Go."""
...
class Container:
    """IoC container managing singleton services and adapters for DPX-Go."""
    ...
    def parser(self) -> ParserPort:
        if self._parser is None:
            self._parser = NativeGoParserAdapter()
        return self._parser
