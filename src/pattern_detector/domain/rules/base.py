"""Base abstractions and protocol for Go pattern detection rules."""
...
class PatternRule(Protocol):
    """Protocol that every Go pattern detection rule must satisfy."""
...
class BasePatternRule(ABC):
    """Base class for Go pattern rules."""
