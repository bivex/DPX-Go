"""Domain value objects for the Go Pattern Detector."""
...
class PatternCategory(str, Enum):
    """Broad classification of design patterns, Go idioms, and engineering principles."""
...
class PatternType(str, Enum):
    """Specific design pattern, Go idiom, and engineering principle identifiers."""
    ...
    # Go-Specific Idioms & Concurrency Patterns
    PIPELINE = "pipeline"
    FAN_OUT_FAN_IN = "fan_out_fan_in"
    WORKER_POOL = "worker_pool"
    GENERATOR = "generator"
    CONTEXT_PROPAGATION = "context_propagation"
    ERRGROUP_CONCURRENCY = "errgroup_concurrency"
    ...
    # Safety & Resource Leak Guards
    GOROUTINE_LEAK_RISK = "goroutine_leak_risk"
...
class SourceLocation:
    """Represents a precise location in a Go source code file."""
