"""Application scanning service orchestrating Go source retrieval, parsing, and rule execution."""
...
class ScanningService(ScannerPort):
    """End-to-end scanning orchestrator for Go projects."""
    ...
    def scan_path(self, path: str, options: ScanOptions | None = None) -> DetectionReport:
        ...
        sources = self._source_provider.get_sources(path, extensions=[".go"])
